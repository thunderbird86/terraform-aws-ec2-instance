...
| <a name="input_aws_route53_ttl"></a> [aws\_route53\_ttl](#input\_aws\_route53\_ttl) | DNS record TTL | `string` | `"300"` | no |
...
| <a name="input_create_eip"></a> [create\_eip](#input\_create\_eip) | Determines whether create EIP | `bool` | `false` | no |
| <a name="input_create_eni"></a> [create\_eni](#input\_create\_eni) | Determines whether create ENI | `bool` | `false` | no |
...
| <a name="input_create_sg"></a> [create\_sg](#input\_create\_sg) | Determines whether create Security Group | `bool` | `false` | no |
...
| <a name="input_route53_recod_name"></a> [route53\_recod\_name](#input\_route53\_recod\_name) | DNS name for instance | `string` | `""` | no |
| <a name="input_route53_recod_type"></a> [route53\_recod\_type](#input\_route53\_recod\_type) | DNS record type | `string` | `"A"` | no |
| <a name="input_route53_recod_zone_id"></a> [route53\_recod\_zone\_id](#input\_route53\_recod\_zone\_id) | Route53 Zone ID | `string` | `""` | no |
| <a name="input_secondary_private_ips"></a> [secondary\_private\_ips](#input\_secondary\_private\_ips) | A list of secondary private IPv4 addresses to assign to the instance's primary network interface (eth0) in a VPC. Can only be assigned to the primary network interface (eth0) attached at instance creation, not a pre-existing network interface i.e. referenced in a `network_interface block` | `list(string)` | `null` | no |
| <a name="input_sg_rules"></a> [sg\_rules](#input\_sg\_rules) | List of ingress rules to create by name | `any` | `{}` | no |
...
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | VPC ID is required for creating Security Group | `string` | `""` | no |
...
| <a name="output_security_group_arn"></a> [security\_group\_arn](#output\_security\_group\_arn) | ARN of security group |
| <a name="output_security_group_id"></a> [security\_group\_id](#output\_security\_group\_id) | ID of security group |
| <a name="output_security_group_name"></a> [security\_group\_name](#output\_security\_group\_name) | ID of security group |
